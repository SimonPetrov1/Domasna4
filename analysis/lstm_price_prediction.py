...
from .analysis_strategy import AnalysisStrategy  # твојот Strategy interface

class LSTMAnalysis(AnalysisStrategy):
    """
    Concrete Strategy: LSTM Analysis
    """
    ...
    def analyze(self, return_results=False):
        ...
        data_path = os.path.join(project_root, "data", "processed", "all_coins.csv")
        ...
        # Врати резултати ако се повикува од Flask
        if return_results:
            return y_test_inv, y_pred_inv

        # Иначе покажи plot (standalone)
